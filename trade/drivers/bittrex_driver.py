...
ACCOUNT_SET = {'getbalances', 'getbalance', 'getdepositaddress', 'withdraw', 'getorderhistory', 'getwithdrawalhistory',
               'getdeposithistory'}
...
class Bittrex(object):
    ...
    def get_deposithistory(self):
        return self.api_query('getdeposithistory')

    def get_withdrawalhistory(self):
